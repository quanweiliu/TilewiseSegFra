...
class SpatialPath(nn.Module):
    def __init__(self, bands, *args, **kwargs):
        ...
        self.conv1 = ConvBNReLU(bands, 64, ks=7, stride=2, padding=3)
...
class ABCNet(nn.Module):
    def __init__(self, bands1, bands2=None, n_classes=2, classification="Multi"):
        super(ABCNet, self).__init__()
        self.cp = ContextPath(bands1)
        self.sp = SpatialPath(bands1)
