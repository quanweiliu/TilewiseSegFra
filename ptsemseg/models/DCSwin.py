...
if __name__ == "__main__":
    ...
    net = dcswin_tiny(num_classes=1, weight_path="/home/leo/Semantic_Segmentation/CNNvsTransformerHSI/pretrain_weights/stseg_tiny.pth")
    # net = dcswin_base(num_classes=1, weight_path="/home/leo/Semantic_Segmentation/CNNvsTransformerHSI/pretrain_weights/stseg_base.pth")
    out = net(in_ten)
