...
'''
https://github.com/YangLibuaa/DE-DCGCN-EE/blob/main/model/sobel.py
'''
...
class GCN(nn.Module):
    ...
    def forward(self, x):
        ...
        for i in range(0, b):
            ...
            c_adj_s = (c_adj_s.t() + c_adj_s) / 2   # (512,512)
...
class DEDCGCNEE(nn.Module):
    def __init__(self, in_x=193, in_y=3, n_classes=2, classification="Multi"):
        ...
        self.Conv1 = conv_block(ch_in=in_x, ch_out=64)
        self.Conv2 = conv_block(ch_in=64, ch_out=128)
        self.Conv3 = conv_block(ch_in=128, ch_out=256)
        self.Conv4 = conv_block(ch_in=256, ch_out=512)

        self.Conv5 = conv_block(ch_in=in_y, ch_out=64)
    ...
    def forward(self, x, y):
        ...
        # 128 x4 torch.Size([4, 512, 16, 16]) y4 torch.Size([4, 512, 16, 16])
