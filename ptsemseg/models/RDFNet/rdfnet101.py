...
# from ptsemseg.models.DuiBi.RDFNet_PyTorch.blocks import MMFBlock, RefineNetBlock, ResidualConvUnit
# from ptsemseg.models.DuiBi.RDFNet_PyTorch.resnet101 import get_resnet50, get_resnet101
...
class RDF(nn.Module):
    def __init__(self, input_size=512, num_classes=1, bn_momentum=0.0003, features=256, pretained=False):
        ...
        self.rgb_conv_bn_relu1=nn.Sequential(
            nn.Conv2d(4, 64, 3, stride=2, padding=1, bias=False),
        ...
        self.hha_conv_bn_relu1=nn.Sequential(
            nn.Conv2d(2, 64, 3, stride=2, padding=1, bias=False),
            nn.BatchNorm2d(64, momentum=bn_momentum),
            nn.ReLU(inplace=False)
        )
