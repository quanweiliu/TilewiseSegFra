...
class RDF50(nn.Module):
    def __init__(self, bands1, bands2, input_size=512, num_classes=1, \
                 bn_momentum=0.0003, features=256, pretained=True, classification="Multi"):
        ...
        self.rgblayer1 = nn.Sequential(self.rgb_conv_bn_relu1,
                                       ...
                                       self.Resnet50rgb.relu2,
                                       self.Resnet50rgb.conv3, 
                                       self.Resnet50rgb.bn3, 
                                       self.Resnet50rgb.relu3,
        ...
        self.hhalayer1 = nn.Sequential(self.hha_conv_bn_relu1,
                                       ...
                                       self.Resnet50hha.relu2,
                                       self.Resnet50hha.conv3, 
                                       self.Resnet50hha.bn3, 
                                       self.Resnet50hha.relu3,
        ...
        self.hhalayer4 = self.Resnet50hha.layer4
