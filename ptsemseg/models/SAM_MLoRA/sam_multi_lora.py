...
from ptsemseg.models.SAM_MLoRA.mlora import MultiLoraLinear
...
def build_sam_adapter_linknet(
    ...
    if freeze_strategy == 'all_except_adapter':
        ...
        freeze_early_layers(encoder, freeze_until_block=freeze_until_block)
    ...
    # 只在 encoder 里所有 nn.Linear 上加 LoRA（是不是有点多？？？maybe）
...
def build_sam_vit_b_adapter_linknet_multi_lora(checkpoint=None, 
                                                image_size=1024, 
                                                n_classes=6, 
                                                freeze_strategy='all_except_adapter', 
                                                freeze_until_block=10):
