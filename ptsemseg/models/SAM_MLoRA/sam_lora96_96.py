...
from ptsemseg.models.SAM_MLoRA.mlora import LoraLinear
...
def build_sam_adapter_linknet(
    ...
    encoder = LoraLinear.convert_lora_linear(encoder, r=96, lora_alpha=96, lora_dropout=0.1, merge_weights=False)
...
def build_sam_vit_b_adapter_linknet_lora96_96(checkpoint=None, image_size=1024, n_classes=6):
