...
class DecoderCup(nn.Module):
    def __init__(self):
        ...
        self.n_skip = 3
        self.conv_more = Conv2dReLU(256, 256, kernel_size=3, padding=1, use_batchnorm=True, )
        in_channels = [256, 128, 64, 32]
        out_channels = [128, 64, 32, 16]
        skip_channels = [128, 64, 64, 0]
    ...
    def forward(self, hidden_states, features=None):
        ...
        #     print("--- Checking Encoder Features ---")
...
class MGFNet_Wu34(nn.Module):
    def __init__(self, bands1, bands2, num_classes=6, classification="Multi"):
        ...
        self.csam_layer2 = CMI(in_dim=128)
        self.csam_layer3 = CMI(in_dim=256)

        
        self.se_layer0 = MGF(64, 64)
        self.se_layer1 = MGF(64, 64)
        self.se_layer2 = MGF(128, 128)
        self.se_layer3 = MGF(256, 256)

        
        self.PAME = CMME(dim=256, in_dim=256)
...
if __name__ == "__main__":
    ...
    model = MGFNet_Wu34(bands1, bands2, num_classes=1, classification="Multi").to(device)
