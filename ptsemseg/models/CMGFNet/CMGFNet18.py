...
class CMGFNet18(nn.Module):
    ...
    def __init__(self, bands1, bands2, n_classes, classification="Multi", pretrained="ResNet18_Weights.IMAGENET1K_V1"):
        ...
        self.resnet_features = torchvision.models.resnet18(weights="ResNet18_Weights.DEFAULT")
        ...
        # DSM Encoder Part
        self.encoder_depth = torchvision.models.resnet18(weights=self.pretrained)
