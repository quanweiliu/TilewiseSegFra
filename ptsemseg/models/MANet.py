...
class MANet(nn.Module):
    def __init__(self, num_channels=3, bands=None, num_classes=5, \
                 classification="Multi", backbone_name='resnet18', pretrained=True):
        super(MANet, self).__init__()
        self.pre_conv = ConvBN(num_channels, 3, kernel_size=3)
...
if __name__ == "__main__":
    ...
    net = MANet(num_channels=bands, num_classes=1,
                classification="Multi", backbone_name='resnet18', pretrained=True)
    out = net(input)
