...
from ptsemseg.schedulers2 import get_scheduler, get_warmup
...
def train(cfg, rundir):
    ...
    if data_name == "OSTD":
        ...
        t_loader = ISPRS_loader(data_path, train_split, img_size, classes=classes, 
                                data_name=data_name, normalization=normalization, is_augmentation=True)
        v_loader = ISPRS_loader(data_path, val_split, img_size, classes=classes, 
    ...
    ## scheduler
    if cfg['model']['arch'] == "CMANet":
        scheduler_warmup = get_warmup(optimizer, cfg)
...
################################# train ###################################################
    ...
    while i < cfg['data']['train_epoch'] and flag:      #  Number of total training iterations
        ...
        if i % 1 == 0:
            ...
            if cfg['model']['arch'] == "CMANet":
                if i <= cfg['training']['warm_up']['warmup_epoch']:
...
if __name__ ==  "__main__":
    ...
    parser.add_argument(
        ...
        nargs = "?",
        type = str,
        # default = "/home/icclab/Documents/lqw/Multimodal_Segmentation/TilewiseSegFra/config_multi/ACNet.yml",
        # default = "/home/icclab/Documents/lqw/Multimodal_Segmentation/TilewiseSegFra/config_multi/CANet50.yml",
        # default = "/home/icclab/Documents/lqw/Multimodal_Segmentation/TilewiseSegFra/config_multi/CMANet.yml",
        # default = "/home/icclab/Documents/lqw/Multimodal_Segmentation/TilewiseSegFra/config_multi/CMGFNet18.yml",
        default = "/home/icclab/Documents/lqw/Multimodal_Segmentation/TilewiseSegFra/config_multi/CMGFNet34.yml",
    ...
    parser.add_argument(
        "--model_path",
        type = str,
        # default = os.path.join("/home/icclab/Documents/lqw/Multimodal_Segmentation/TilewiseSegFra/run_NYUv2/1006-1507-CMANet", "best.pt"),
        default = None,
        help="Path to the saved model")
