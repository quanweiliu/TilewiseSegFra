...
def test(args):
    ...
    if args.data_name == "OSTD":
        ...
        test_dataset = ISA_loader3.ISA_loader3(transforms.Compose([ISA_loader3.scaleNorm(),
    ...
    with torch.no_grad():
        ...
        for ind, sample in enumerate(tqdm(testloader)):
            ...
            if args.TTA:
                ...
                outputs = tta_inference(model, gaofen, lidar)
...
if __name__=='__main__':
    ...
    parser.add_argument('--model',
                        ...
                        default="DE_CCFNet34_3B", help="the model architecture that should be trained")
