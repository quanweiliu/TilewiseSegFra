...
class ISPRS_loader3(data.DataLoader):
    def __init__(self,
                 root,
                 txt_name='train.txt',
                 img_size=512,
...
if __name__ == '__main__':
    ...
    # dataset = ISPRS_loader3(root, split='train', img_size=256, is_augmentation=False)
    dataset = ISPRS_loader3(root, txt_name='train.txt', img_size=256, is_augmentation=True)
