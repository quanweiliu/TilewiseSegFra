...
if __name__=='__main__':
    ...
    parser.add_argument("--imgs_path", nargs = "?", type = str, \
                        default = '/home/leo/MMF/OSD_H', help="Path of the input image")
    ...
    parser.add_argument("--config", nargs = "?", type = str,
                        default = "/home/leo/Semantic_Segmentation/multiRoadHSI/config/extraction_epoch_ACNet.yml",
    ...
    parser.add_argument("--model_path", nargs = "?", type = str, \
                        default = os.path.join("/home/leo/Semantic_Segmentation/multiRoadHSI/runs/0228-1049-ACNet", "ACNet_best_model_temp.pkl"), 
                        # default = os.path.join("/home/leo/Semantic_Segmentation/multiRoadHSI/runs/0919-1138-CMANet", "best_model_temp.pkl"),
                        # default = os.path.join("/home/leo/Semantic_Segmentation/multiRoadHSI/runs/0918-1405-CMANet", "best_model_temp.pkl"),
                        # default = os.path.join("/home/leo/Semantic_Segmentation/multiRoadHSI/FinalResults/0803-1025-CMGFNet", "best_model_temp.pkl"), 
